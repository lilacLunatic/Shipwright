...
void Settings::CreateOptionDescriptions() {
    ...
    mOptionDescriptions[RSK_SHUFFLE_INVISIBLE_ITEMS] = "Invisible items can only be found at the right location "
                                              "and will be revealed when picked up. These can be hard to find "
                                              "if you don't know where to look. Use the Check Tracker if you "
                                              "get stuck.\n"
                                              "\n"
                                              "Off - Invisible items will not be shuffled.\n"
                                              "\n"
                                              "Dungeons - Only invisible items that are within dungeons.\n"
                                              "\n"
                                              "Overworld - Only invisible items that are outside of dungeons.\n"
                                              "\n"
                                              "All Items - Shuffle all invisible items.";
    mOptionDescriptions[RSK_SHUFFLE_WONDER_SPOTS] = "Wonder spots require special actions in order to appear. "
                                              "This can be stepping in the right places in sequence, or attacking "
                                              "a specific object in a specific way before the item is revealed. "
                                              "These can be very hard to find if you aren't already familiar with "
                                              "them. The Check Tracker can provide hints on where to look, "
                                              "while Gossip Stones may hint towards how to reveal them.\n"
                                              "\n"
                                              "Off - Wonder spots will not be shuffled.\n"
                                              "\n"
                                              "Dungeons - Only wonder spots that are within dungeons.\n"
                                              "\n"
