...
void AreaTable_Init_ZorasDomain() {
  areaTable[RR_ZR_FRONT] = Area("ZR Front", "Zora River", RA_ZORAS_RIVER, DAY_NIGHT_CYCLE, {}, {
                  ...
                  LOCATION(RC_ZR_DOWNSTREAM_RUPEE_3,                    logic->IsChild && logic->HasItem(RG_BRONZE_SCALE)),
                  LOCATION(RC_ZR_DOWNSTREAM_RUPEE_4,                    logic->IsChild && logic->HasItem(RG_BRONZE_SCALE)),
                  LOCATION(RC_ZR_DOWNSTREAM_RUPEE_5,                    logic->IsChild && logic->HasItem(RG_BRONZE_SCALE)),
                  LOCATION(RC_ZR_DOWNSTREAM_RUPEE_6,                    logic->IsChild && logic->HasItem(RG_BRONZE_SCALE)),
                  LOCATION(RC_ZR_DOWNSTREAM_RUPEE_7,                    logic->IsChild && logic->HasItem(RG_BRONZE_SCALE)),
                }, {
                  //Exits
  ...
  areaTable[RR_ZORAS_RIVER] = Area("Zora River", "Zora River", RA_ZORAS_RIVER, DAY_NIGHT_CYCLE, {
                  ...
                  LOCATION(RC_ZR_BENEATH_WATERFALL_LEFT_RUPEE,          logic->IsAdult && logic->HasItem(RG_BRONZE_SCALE)),
                  LOCATION(RC_ZR_BENEATH_WATERFALL_MIDDLE_LEFT_RUPEE,   logic->IsAdult && logic->HasItem(RG_BRONZE_SCALE)),
                  LOCATION(RC_ZR_BENEATH_WATERFALL_MIDDLE_RIGHT_RUPEE,  logic->IsAdult && logic->HasItem(RG_BRONZE_SCALE)),
                  LOCATION(RC_ZR_BENEATH_WATERFALL_RIGHT_RUPEE,         logic->IsAdult && logic->HasItem(RG_BRONZE_SCALE)),
                  LOCATION(RC_ZR_UPSTREAM_RUPEE_1,                      logic->IsChild && logic->HasItem(RG_BRONZE_SCALE)),
                  LOCATION(RC_ZR_UPSTREAM_RUPEE_2,                      logic->IsChild && logic->HasItem(RG_BRONZE_SCALE)),
                  LOCATION(RC_ZR_UPSTREAM_RUPEE_3,                      logic->IsChild && logic->HasItem(RG_BRONZE_SCALE)),
                  LOCATION(RC_ZR_UPSTREAM_RUPEE_4,                      logic->IsChild && logic->HasItem(RG_BRONZE_SCALE)),
                  LOCATION(RC_ZR_FORK_RUPEE,                            logic->IsChild && logic->HasItem(RG_BRONZE_SCALE)),
                  LOCATION(RC_ZR_NORTH_RUPEE_1,                         logic->IsChild && logic->HasItem(RG_BRONZE_SCALE)),
                  LOCATION(RC_ZR_NORTH_RUPEE_2,                         logic->IsChild && logic->HasItem(RG_BRONZE_SCALE)),
                  LOCATION(RC_ZR_NORTH_RUPEE_3,                         logic->IsChild && logic->HasItem(RG_BRONZE_SCALE)),
                  LOCATION(RC_ZR_NORTH_RUPEE_4,                         logic->IsChild && logic->HasItem(RG_BRONZE_SCALE)),
                  LOCATION(RC_ZR_NORTH_RUPEE_5,                         logic->IsChild && logic->HasItem(RG_BRONZE_SCALE)),
                  LOCATION(RC_ZR_NORTH_RUPEE_6,                         logic->IsChild && logic->HasItem(RG_BRONZE_SCALE)),
                  LOCATION(RC_ZR_NORTH_RUPEE_7,                         logic->IsChild && logic->HasItem(RG_BRONZE_SCALE)),
                  LOCATION(RC_ZR_NORTH_RUPEE_8,                         logic->IsChild && logic->HasItem(RG_BRONZE_SCALE)),
                  LOCATION(RC_ZR_NORTH_RUPEE_9,                         logic->IsChild && logic->HasItem(RG_BRONZE_SCALE)),
                  LOCATION(RC_ZR_NORTH_RUPEE_10,                        logic->IsChild && logic->HasItem(RG_BRONZE_SCALE)),
                  LOCATION(RC_ZR_NORTH_RUPEE_11,                        logic->IsChild && logic->HasItem(RG_BRONZE_SCALE)),
                  LOCATION(RC_ZR_SOUTH_RUPEE_1,                         logic->IsChild && logic->HasItem(RG_BRONZE_SCALE)),
                  LOCATION(RC_ZR_SOUTH_RUPEE_2,                         logic->IsChild && logic->HasItem(RG_BRONZE_SCALE)),
                  LOCATION(RC_ZR_SOUTH_RUPEE_3,                         logic->IsChild && logic->HasItem(RG_BRONZE_SCALE)),
                  LOCATION(RC_ZR_SOUTH_RUPEE_4,                         logic->IsChild && logic->HasItem(RG_BRONZE_SCALE)),
                  LOCATION(RC_ZR_SOUTH_RUPEE_5,                         logic->IsChild && logic->HasItem(RG_BRONZE_SCALE)),
                  LOCATION(RC_ZR_SOUTH_RUPEE_6,                         logic->IsChild && logic->HasItem(RG_BRONZE_SCALE)),
                  LOCATION(RC_ZR_SOUTH_RUPEE_7,                         logic->IsChild && logic->HasItem(RG_BRONZE_SCALE)),
                  LOCATION(RC_ZR_SOUTH_RUPEE_8,                         logic->IsChild && logic->HasItem(RG_BRONZE_SCALE)),
                  LOCATION(RC_ZR_DOWNSTREAM_RUPEE_1,                    logic->IsChild && logic->HasItem(RG_BRONZE_SCALE)),
                  LOCATION(RC_ZR_DOWNSTREAM_RUPEE_2,                    logic->IsChild && logic->HasItem(RG_BRONZE_SCALE)),
  ...
  areaTable[RR_ZORAS_FOUNTAIN] = Area("Zoras Fountain", "Zoras Fountain", RA_ZORAS_FOUNTAIN, NO_DAY_NIGHT_CYCLE, {
                  ...
                  LOCATION(RC_ZF_SCARECOW_RUPEE,                logic->IsAdult && logic->HasItem(RG_SCARECROW)),
