...
typedef enum {
    ...
    RAND_INF_KF_BOULDER_HIDDEN_RUPEE_1,
    RAND_INF_KF_BOULDER_HIDDEN_RUPEE_2,
    RAND_INF_KF_SMALL_ISLANDS,
    RAND_INF_KF_STEPPING_STONES,
    RAND_INF_MARKET_BOWLING_BALCONY_DAY_RIGHT,
    RAND_INF_MARKET_BOWLING_BALCONY_DAY_MIDDLE_RIGHT,
    RAND_INF_MARKET_BOWLING_BALCONY_DAY_MIDDLE,
    RAND_INF_MARKET_BOWLING_BALCONY_DAY_MIDDLE_LEFT,
    RAND_INF_MARKET_BOWLING_BALCONY_DAY_LEFT,
    RAND_INF_GRAVEYARD_DAMPE_RACE_HIDDEN_RUPEE_1,
    RAND_INF_GRAVEYARD_DAMPE_RACE_HIDDEN_RUPEE_2,
    RAND_INF_GRAVEYARD_DAMPE_RACE_HIDDEN_RUPEE_3,
    RAND_INF_GRAVEYARD_DAMPE_RACE_HIDDEN_RUPEE_4,
    RAND_INF_GRAVEYARD_DAMPE_RACE_HIDDEN_RUPEE_5,
    RAND_INF_GRAVEYARD_DAMPE_RACE_HIDDEN_RUPEE_6,
    RAND_INF_GRAVEYARD_DAMPE_RACE_HIDDEN_RUPEE_7,
    RAND_INF_GRAVEYARD_DAMPE_RACE_HIDDEN_RUPEE_8,
    RAND_INF_GRAVEYARD_DAMPE_RACE_HIDDEN_RUPEE_9,
    RAND_INF_GRAVEYARD_DAMPE_RACE_HIDDEN_RUPEE_10,
    RAND_INF_GRAVEYARD_DAMPE_RACE_HIDDEN_RUPEE_11,
    RAND_INF_GRAVEYARD_DAMPE_RACE_HIDDEN_RUPEE_12,
    RAND_INF_GRAVEYARD_DAMPE_RACE_HIDDEN_RUPEE_13,
    RAND_INF_GRAVEYARD_DAMPE_RACE_HIDDEN_RUPEE_14,
    RAND_INF_GRAVEYARD_DAMPE_RACE_HIDDEN_RUPEE_15,
    RAND_INF_HF_DRAWBRIDGE_RIGHT,
    RAND_INF_HF_DRAWBRIDGE_MIDDLE,
    RAND_INF_HF_DRAWBRIDGE_LEFT,
    RAND_INF_ZR_UPSTREAM_RUPEE_1,
    RAND_INF_ZR_UPSTREAM_RUPEE_2,
    RAND_INF_ZR_UPSTREAM_RUPEE_3,
    RAND_INF_ZR_UPSTREAM_RUPEE_4,
    RAND_INF_ZR_FORK_RUPEE,
    RAND_INF_ZR_NORTH_RUPEE_1,
    RAND_INF_ZR_NORTH_RUPEE_2,
    RAND_INF_ZR_NORTH_RUPEE_3,
    RAND_INF_ZR_NORTH_RUPEE_4,
    RAND_INF_ZR_NORTH_RUPEE_5,
    RAND_INF_ZR_NORTH_RUPEE_6,
    RAND_INF_ZR_NORTH_RUPEE_7,
    RAND_INF_ZR_NORTH_RUPEE_8,
    RAND_INF_ZR_NORTH_RUPEE_9,
    RAND_INF_ZR_NORTH_RUPEE_10,
    RAND_INF_ZR_NORTH_RUPEE_11,
    RAND_INF_ZR_SOUTH_RUPEE_1,
    RAND_INF_ZR_SOUTH_RUPEE_2,
    RAND_INF_ZR_SOUTH_RUPEE_3,
    RAND_INF_ZR_SOUTH_RUPEE_4,
    RAND_INF_ZR_SOUTH_RUPEE_5,
    RAND_INF_ZR_SOUTH_RUPEE_6,
    RAND_INF_ZR_SOUTH_RUPEE_7,
    RAND_INF_ZR_SOUTH_RUPEE_8,
    RAND_INF_ZR_DOWNSTREAM_RUPEE_1,
    RAND_INF_ZR_DOWNSTREAM_RUPEE_2,
    RAND_INF_ZR_DOWNSTREAM_RUPEE_3,
    RAND_INF_ZR_DOWNSTREAM_RUPEE_4,
    RAND_INF_ZR_DOWNSTREAM_RUPEE_5,
    RAND_INF_ZR_DOWNSTREAM_RUPEE_6,
    RAND_INF_ZR_DOWNSTREAM_RUPEE_7,
    RAND_INF_SFM_ENTRANCE_BUSH,
    RAND_INF_SFM_SOUTH_MAZE_BUSH_1,
    RAND_INF_SFM_SOUTH_MAZE_BUSH_2,
    RAND_INF_SFM_SOUTH_MAZE_BUSH_3,
    RAND_INF_SFM_NORTH_MAZE_WEST_BUSH,
    RAND_INF_SFM_NORTH_MAZE_EAST_BUSH,
    RAND_INF_ZF_SCARECOW_RUPEE,
    RAND_INF_GV_LADDER_RUPEE,
    RAND_INF_GV_WATERFALL_RUPEE,
    RAND_INF_LW_OCARINA_GAME_NORTH_BUSH,
    RAND_INF_LW_OCARINA_GAME_WEST_BUSH,
    RAND_INF_LW_OCARINA_GAME_EAST_BUSH,
    RAND_INF_COLOSSUS_FAIRY_EAST_PALM_TREE,
    RAND_INF_COLOSSUS_FAIRY_WEST_PALM_TREE,
    RAND_INF_COLOSSUS_CHILD_OASIS_WEST_PALM_TREE,
    RAND_INF_COLOSSUS_CHILD_OASIS_EAST_PALM_TREE,
    RAND_INF_COLOSSUS_CHILD_OASIS_SOUTHEAST_PALM_TREE,
    RAND_INF_COLOSSUS_ADULT_OASIS_EAST_PALM_TREE,
    RAND_INF_COLOSSUS_ADULT_OASIS_SOUTHEAST_PALM_TREE,
    RAND_INF_GF_WELCOME_SIGN,
    RAND_INF_GF_TO_ARCHERY_SIGN,
    RAND_INF_GF_NORTH_F1_NORTH_SKULL,
    RAND_INF_GF_NORTH_F1_SOUTH_SKULL,
    RAND_INF_GF_OUTSIDE_KITCHEN_SKULL,
    RAND_INF_GF_KITCHEN_SOUP_POT,
    RAND_INF_GF_NORTH_F2_NEAR_CELL_SKULL,
    RAND_INF_GF_NORTH_F2_HALLWAY_SKULL,
    RAND_INF_GF_ABOVE_CELL_EAST_SKULL,
    RAND_INF_GF_ABOVE_CELL_WEST_SKULL,
    RAND_INF_GF_SOUTH_F1_NORTH_SKULL,
    RAND_INF_GF_SOUTH_F1_SOUTH_SKULL,
    RAND_INF_GF_SOUTH_F2_WEST_SKULL,
    RAND_INF_GF_SOUTH_F2_EAST_SKULL,
    RAND_INF_HC_MOAT_RUPEE_1,
    RAND_INF_HC_MOAT_RUPEE_2,
    RAND_INF_HC_MOAT_RUPEE_3,
    RAND_INF_HC_MOAT_RUPEE_4,
    RAND_INF_HC_MOAT_RUPEE_5,
    RAND_INF_HC_MOAT_RUPEE_6,
    RAND_INF_HC_MOAT_RUPEE_7,
    RAND_INF_HC_MOAT_RUPEE_8,
    RAND_INF_HC_MOAT_RUPEE_9,
    RAND_INF_HC_MOAT_RUPEE_FINAL,
    RAND_INF_HC_DRAWBRIDGE_EAST_TORCH,
    RAND_INF_HC_DRAWBRIDGE_WEST_TORCH,
    RAND_INF_DMC_UNDER_BRIDGE_RUPEE,
    RAND_INF_LLR_EAST_HURDLE,
    RAND_INF_LLR_WEST_HURDLE,
    RAND_INF_DEKU_TREE_MQ_SOUTHEAST_GRAVE,
    RAND_INF_DEKU_TREE_MQ_WEST_GRAVE,
    RAND_INF_DEKU_TREE_MQ_NORTHEAST_GRAVE,
    RAND_INF_DEKU_TREE_MQ_NORTHWEST_GRAVE,
    RAND_INF_JABU_JABUS_BELLY_MQ_FALLING_LIKE_LIKE_ROOM_BOMB_GRASS,
    RAND_INF_JABU_JABUS_BELLY_MQ_FALLING_LIKE_LIKE_ROOM_LEFT_COW,
    RAND_INF_JABU_JABUS_BELLY_MQ_FALLING_LIKE_LIKE_ROOM_RIGHT_COW,
    RAND_INF_JABU_JABUS_BELLY_MQ_AFTER_BIG_OCTO_COW_1,
    RAND_INF_JABU_JABUS_BELLY_MQ_AFTER_BIG_OCTO_COW_2,
    RAND_INF_JABU_JABUS_BELLY_MQ_AFTER_NEAR_BOSS_EAST_COW,
    RAND_INF_JABU_JABUS_BELLY_MQ_AFTER_NEAR_BOSS_WEST_COW_LOW,
    RAND_INF_JABU_JABUS_BELLY_MQ_AFTER_NEAR_BOSS_WEST_COW_MID,
    RAND_INF_FIRE_TEMPLE_MQ_BOSS_KEY_ROOM_FACE,
    RAND_INF_FIRE_TEMPLE_MQ_SHORTCUT_ROOM_FLOOR,
    RAND_INF_FIRE_TEMPLE_MQ_LIZALFOS_MAZE_FACE,
    RAND_INF_FIRE_TEMPLE_MQ_SUSPENDED_PLATFORMS_FACE,
    RAND_INF_FIRE_TEMPLE_MQ_EAST_TOWER_LARGE_FACE,
    RAND_INF_FIRE_TEMPLE_MQ_EAST_TOWER_SMALL_FACE,
    RAND_INF_FIRE_TEMPLE_MQ_FIRE_WALL_MAZE_FACE,
    RAND_INF_FIRE_TEMPLE_MQ_WEST_TOWER_FACE,
    RAND_INF_FIRE_TEMPLE_MQ_STAIRCASE_FACE,
    RAND_INF_WATER_TEMPLE_MQ_EAST_LOWER_MURAL,
    RAND_INF_WATER_TEMPLE_MQ_CENTRAL_PILLAR_MURAL,
    RAND_INF_WATER_TEMPLE_MQ_LIZALFOS_HALLWAY_MURAL,
    RAND_INF_WATER_TEMPLE_MQ_WATERFALL_LEFT_MURAL,
    RAND_INF_WATER_TEMPLE_MQ_WATERFALL_RIGHT_MURAL_1,
    RAND_INF_WATER_TEMPLE_MQ_WATERFALL_RIGHT_MURAL_2,
    RAND_INF_WATER_TEMPLE_MQ_WATERFALL_RIGHT_MURAL_3,
    RAND_INF_WATER_TEMPLE_MQ_AFTER_DARK_LINK_MURAL,
    RAND_INF_WATER_TEMPLE_MQ_WHIRLPOOL_BACK_ROOM_MURAL,
    RAND_INF_WATER_TEMPLE_MQ_WHIRLPOOL_ROOM_DRAGON_LEFT_EYE,
    RAND_INF_WATER_TEMPLE_MQ_WHIRLPOOL_ROOM_DRAGON_RIGHT_EYE,
    RAND_INF_WATER_TEMPLE_MQ_TRIPLE_WALL_TORCH_MURAL,
    RAND_INF_WATER_TEMPLE_MQ_FREESTANDING_KEY_MURAL,
    RAND_INF_WATER_TEMPLE_MQ_TORCHES_NEAR_FREESTANDING_KEY_FIRST_GEYSER,
    RAND_INF_WATER_TEMPLE_MQ_TORCHES_NEAR_FREESTANDING_KEY_THIRD_GEYSER,
    RAND_INF_WATER_TEMPLE_MQ_BEFORE_UPPER_WATER_SWITCH_MURAL,
    RAND_INF_WATER_TEMPLE_MQ_BEFORE_BOSS_WEST_MURAL,
    RAND_INF_WATER_TEMPLE_MQ_BEFORE_BOSS_EAST_MURAL,
    RAND_INF_SHADOW_TEMPLE_MQ_POTS_PLAQUE,
    RAND_INF_SPIRIT_TEMPLE_MQ_CHEST_SWITCH,
    RAND_INF_GERUDO_TRAINING_GROUND_BEAMOS_PLAQUE,
    RAND_INF_GERUDO_TRAINING_GROUND_HAMMER_ROOM_PLAQUE,
    RAND_INF_GERUDO_TRAINING_GROUND_MQ_DINALFOS_PLAQUE,
    RAND_INF_BOTTOM_OF_THE_WELL_MQ_EAST_FACE_1,
    RAND_INF_BOTTOM_OF_THE_WELL_MQ_EAST_FACE_2,
    RAND_INF_BOTTOM_OF_THE_WELL_MQ_EAST_FACE_3,
    RAND_INF_BOTTOM_OF_THE_WELL_MQ_WEST_FACE,
    RAND_INF_BOTTOM_OF_THE_WELL_MQ_EAST_INNER_ROOM_FACE,
