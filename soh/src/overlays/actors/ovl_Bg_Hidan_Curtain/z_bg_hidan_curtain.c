...
void BgHidanCurtain_WaitForSlugPower(BgHidanCurtain* this, GlobalContext* globalCtx);
...
void BgHidanCurtain_WaitForSlugCease(BgHidanCurtain* this, GlobalContext* globalCtx) {
